...
public class Pregunta8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta_8);
    }
    ...
    {
        Intent intent = new Intent(getApplicationContext(), Pregunta9.class);
        startActivity(intent);
    }
    public void btnBack(View v)
    {
        Intent intent = new Intent(getApplicationContext(), Pregunta7.class);
        startActivity(intent);
    }
}
