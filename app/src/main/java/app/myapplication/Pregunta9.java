...
public class Pregunta9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta_9);
    }
    ...
    {
        Intent intent = new Intent(getApplicationContext(), Pregunta10.class);
        startActivity(intent);
    }
    public void btnBack(View v)
    {
        Intent intent = new Intent(getApplicationContext(), Pregunta8.class);
        startActivity(intent);
    }
}
